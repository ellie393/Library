...
<div class="container">
    <form name="book" action="" method="POST">
        <div class="row">
            ...
            <div class="col-75">
                <@spring.formInput "form.readerID" "" "text"/>
            </div>
        </div>
        <div class="row">
            <div class="col-25">
        ...
        <div class="d-grid gap-2 d-md-block">
            <a href="http://localhost:8080/ui/readers/"><i class="fa fa-chevron-circle-left fa-2x"
                                                           aria-hidden="true"></i></a>
            <button class="glyphicon glyphicon-floppy-disk" type="submit" id="submitButton" value="Save"
